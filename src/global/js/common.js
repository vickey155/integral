...
var commonEvent = function() {
    ...
    var dialogConfirmUrl = function (tip,url,urlTxt) {
        var temp = '<div class="bg-alert-pop"></div><div class="dialog-alert-pop">' +
            '<div class="dialog-cont"><p>' + tip + '</p></div>' +
            '<div class="dialog-btn"><a href="javascript:void(0);" class="close-btn">关闭</a><a class="a-link" href="'+url+ '">'+urlTxt+ '</a>' +
            '</div> </div>';
        $('body').append(temp);
    };
...
var progress = function () {
  ...
  var gradProgress = function () { //等级进度条
